...
export default function FlowDashboard() {
  ...
  // Entrées ajoutées au menu « Importer » natif du navigateur de fichiers (à côté
  // de « Importer des fichiers » qui téléverse les .kbflw). → un seul bouton Importer.
  ...
  // Ouverture d'un fichier .kbflw depuis le navigateur → éditeur.
